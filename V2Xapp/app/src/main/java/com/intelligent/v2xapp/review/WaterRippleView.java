...
// Created by CIDI daiqinxue on 2018/5/30.
...
import com.intelligent.v2xapp.util.UiUtils;
...
public class WaterRippleView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mTotalWidth; i++) {
            ...
            // 绘制第一条水波纹
            canvas.drawLine(i, mTotalHeight - mResetOneYPositions[i] - 600, i,
                    mTotalHeight, mWavePaint);

            // 绘制第二条水波纹
            canvas.drawLine(i, mTotalHeight - mResetTwoYPositions[i] - 600, i,
                    mTotalHeight, mWavePaint);
        }
