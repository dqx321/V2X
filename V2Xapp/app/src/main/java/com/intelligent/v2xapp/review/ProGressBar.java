...
/**
 * Created by daiqinxue on 2018/2/3.
 * 进度条
 *
 */
...
public class ProGressBar extends View {
     ...
     * @return
     */
    public ProGressBar setProgressWithAnimation(float progress) {
        mProgress = progress;
        initAnimation();
        return this;
    }
     ...
     * @return
     */
    public ProGressBar setCurrentProgress(float progress) {
        mProgress = progress;
     ...
     * @return
     */
    public ProGressBar setProgressListener(ProgressListener listener) {
