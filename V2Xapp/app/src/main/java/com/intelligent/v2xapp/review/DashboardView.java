...
public class DashboardView extends View {
    ...
    private int mMax = 220; // 最大值 180
    private int mSection = 11; // 值域（mMax-mMin）等分份数 9
    private int mPortion = 2; // 一个mSection等分份数 2
...
//        canvas.drawColor(ContextCompat.getColor(getContext(), R.color.color_dark));
        canvas.drawCircle(mCenterX,mCenterY,mRadius,paintBg);
        ...
        mPaint.setStrokeWidth(dp2px(3));//2
